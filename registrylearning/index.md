...
Simply, registry is something contains windows's or programme's low-level configures and system stores each entry which has the structure of 'key and value'  in tree shape.
